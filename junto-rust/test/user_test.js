...
diorama.registerScenario('Can register a profile and retrieve', async (s, t, {agent1}) => {
    ...
    const get_username_from_address = await agent1.call('core', 'get_username_from_address', {username_address: user1.Ok.username.address})
    ...
    const get_user_profile_from_address = await agent1.call('core', 'get_user_profile_from_address', {username_address: user1.Ok.username.address})
    ...
    const get_user_profile_by_agent_address = await agent1.call('core', 'get_user_profile_by_agent_address', {})
    ...
    const get_user_username_by_agent_address = await agent1.call('core', 'get_user_username_by_agent_address', {})
