...
scenario.runTape('Retrieve pack and make pack auth operations', async (t, {josh, eric, dora}) => {
        ...
        t.equal(JSON.stringify(register_result_dora), JSON.stringify({"Ok":{"private_den":{"address":"QmW6e5Dj9ALVxD9jZce6dfx1WtgosyeSczGfgSf6GPDPZr","entry":{"parent":"QmWAJausHsWxGvpJJrwtiu6nyQyXDMX426NdghjmHrVfSz","name":"Dora\'s Den","privacy":"Private","channel_type":"Den"}},"shared_den":{"address":"QmWWdGfwqhNCtFx9fz2BiiMNoGA7adnnsUXhggRWzc1kNw","entry":{"parent":"QmWAJausHsWxGvpJJrwtiu6nyQyXDMX426NdghjmHrVfSz","name":"Dora\'s Den","privacy":"Shared","channel_type":"Den"}},"public_den":{"address":"QmbSP2RtMqmRKAG1LBv3RxSMoQ9faRAV8nc7egukD3sEME","entry":{"parent":"QmWAJausHsWxGvpJJrwtiu6nyQyXDMX426NdghjmHrVfSz","name":"Dora\'s Den","privacy":"Public","channel_type":"Den"}},"pack":{"address":"QmctaRRgrRR2o6TXSQZCxtDjnYbqKaf34vwLXUrP5CEGQH","entry":{"parent":"QmWAJausHsWxGvpJJrwtiu6nyQyXDMX426NdghjmHrVfSz","name":"Dora\'s Pack","owner":"QmWAJausHsWxGvpJJrwtiu6nyQyXDMX426NdghjmHrVfSz","privacy":"Shared"}},"profile":{"address":"QmXbgC8Z4YrSbBeirjrShhTTK9zPmUmRUNeav98mHuDa6n","entry":{"parent":"QmWAJausHsWxGvpJJrwtiu6nyQyXDMX426NdghjmHrVfSz","first_name":"Dora","last_name":"Liliom Czovek","bio":"Junto Testing","profile_picture":"pictureurl","verified":true}},"username":{"address":"QmWAJausHsWxGvpJJrwtiu6nyQyXDMX426NdghjmHrVfSz","entry":{"username":"doracat"}}}}));
        console.log("Completed register profile\n\n\n");
