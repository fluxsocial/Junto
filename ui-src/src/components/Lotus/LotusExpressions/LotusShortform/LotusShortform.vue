<template>
  <div class="lotusShortform">
    <div class="lotusShortform__backgrounds">
      <button
        class="lotusShortform__background"
        :class="{ backgroundActive: backgrounds[0].active }"
        @click="backgroundOne"
      >
        &nbsp;
      </button>
      <button
        class="lotusShortform__background"
        :class="{ backgroundActive: backgrounds[1].active }"
        @click="backgroundTwo"
      >
        &nbsp;
      </button>
      <button
        class="lotusShortform__background"
        :class="{ backgroundActive: backgrounds[2].active }"
        @click="backgroundThree"
      >
        &nbsp;
      </button>
      <button
        class="lotusShortform__background"
        :class="{ backgroundActive: backgrounds[3].active }"
        @click="backgroundFour"
      >
        &nbsp;
      </button>
      <button
        class="lotusShortform__background"
        :class="{ backgroundActive: backgrounds[4].active }"
        @click="backgroundFive"
      >
        &nbsp;
      </button>
      <button
        class="lotusShortform__background"
        :class="{ backgroundActive: backgrounds[5].active }"
        @click="backgroundSix"
      >
        &nbsp;
      </button>
...
.lotusShortform__canvas {
  background-image: linear-gradient(
    ...
    url(./../../../../assets/img/junto-web__logo--blue.png);
