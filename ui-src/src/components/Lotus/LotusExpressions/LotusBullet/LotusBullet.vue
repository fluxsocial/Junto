    ...
    <div class="lotusBullet__cards">
      <div class="lotusBullet__card">
        <textarea
          ...
          cols="30"
          rows="10"
          class="lotusBullet__card--text lotusBullet__card--text-title"
...
export default {
  ...
  methods: {
    createBullet() {
      ...
      document
        .querySelector(".lotusBullet__cards")
        .insertAdjacentHTML("beforeend", newBullet);
    }
  }
};
</script>
