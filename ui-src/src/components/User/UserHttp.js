  ...
  return makeHolochainCallAndReturn(
    ...
    .then(result => {
      ...
      if (isSuccess(result) == true) {
        console.log(
          "(getUserProfileByAgentAddress) great success on getting user profile: ",
          result
        );
        ...
        console.log(
          "(getUserProfileByAgentAddress) Error on getting user profile: ",
          result
        );
        template.$notify({
          type: "error",
...
export default {
  ...
  getUserProfileByUsernameAddress
};
